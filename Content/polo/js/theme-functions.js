...
(function ($) {
        ...
        jRes.addFunc([
            {
                ...
                enter: function () {
                    $body.addClass('device-xlg');
                },
                exit: function () {
                    $body.removeClass('device-xlg');
                }
            },
            {
                breakpoint: 'desktop',
    ...
    INSPIRO.sliderHeighControl = function () {
        if ($(".inspiro-slider:not(.development-carousel)").exists()) {
            ...
            if ($body.hasClass('device-xlg') || $body.hasClass('device-lg') || $body.hasClass('device-md') || $body.hasClass('device-sm')) {
...
*/
    ...
    INSPIRO.stickyHeaderStatus = function () {
        if ($header.exists()) {
            ...
            if ($window.scrollTop() > headerOffset) {
                ...
                if ($body.hasClass('device-xlg') || $body.hasClass('device-lg') || $body.hasClass('device-md')) {
    ...
    INSPIRO.animations = function () {
        if (dataAnimation.exists() && $body.hasClass('device-xlg') || $body.hasClass('device-lg') || $body.hasClass('device-md')) {
